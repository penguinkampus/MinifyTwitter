...
if (isset($_POST['submit'])) {
  ...
  $login = $conn->query("SELECT * FROM login WHERE id='$id' AND pass='$pass'");
  $data  = $login->num_rows;
        ...
        <div class="row">
          <div class="col s12 m6">
              ...
              <p>Selamat datang di <b>Minify Twitter</b>. Website ini dibuat untuk memenuhi tugas Pemrograman Web yang berkaitan dengan Sosial Media.
                ...
                Portfolio : <a href="https://me.suaiq.com/">https://me.suaiq.com/ </a></br>
				Github : <a href="https://github.com/iqbalpmgks">https://github.com/iqbalpmgks</a> </br>
                Blog 1 : <a href="https://blog.suaiq.com/">https://blog.suaiq.com/ </a></p>
            </div>
            <div class="col s12 m6">
    ...
    <!--Footer-->
        <footer>
          <div class="row center">
            Copyright &copy; 2016-2018. All right reserved.
          </div>
    <!--End of Footer-->
