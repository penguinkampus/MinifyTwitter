...
<!DOCTYPE html>
  <html>
    ...
    <body>
        ...
        <div class="container">
          ...
          <form action="action.php" method="POST">
            <div class="input-field col s12">
              ...
              <textarea id="textarea1" class="materialize-textarea" name="konten" length="140"></textarea>
      ...
      <?php
      $get = $conn->query("SELECT * FROM tweet ORDER BY id DESC");
      ...
      <div class="section">
	       <div class="row">
		         <div class="col s12">
                  ...
                  <?php echo $_SESSION['id']; ?><p><?php echo $tampil['konten'] ?></p>
